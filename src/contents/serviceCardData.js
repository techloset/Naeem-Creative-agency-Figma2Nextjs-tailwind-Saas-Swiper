export const serviceCardData = [
  {
    ...
    title: "Ideate",
    desc: "We help you develop creative ideas so that your business can grow more rapidly",
    // bgColor: "bg-exact-purple",
    // fillColor: "fill-exact-purple",
    // darkColor: "dark:exact-purple",
    // shadowColor: "shadow-exact-purple",
    exactColor: "exact-purple",
  },
  {
    svgIcon: (
    ...
    // bgColor: "bg-exact-red",
    // fillColor: "fill-exact-red",
    // darkColor: "dark:exact-red",
    // shadowColor: "shadow-exact-red",
    exactColor: "exact-red",
  },
  {
    svgIcon: (
    ...
    // bgColor: "bg-exact-green",
    // fillColor: "fill-exact-green",
    // darkColor: "dark:exact-green",
    // shadowColor: "shadow-exact-green",
    exactColor: "exact-green",
  },
  {
    svgIcon: (
    ...
    desc: "We help you develop creative ideas so that your business can grow more rapidly",
    // bgColor: "bg-exact-yellow",
    // fillColor: "fill-exact-yellow",
    // darkColor: "dark:exact-yellow",
    // shadowColor: "shadow-exact-yellow",
    exactColor: "exact-yellow",
  },
  {
    svgIcon: (
    ...
    desc: "We also provide services by providing input for your business growth",
    // bgColor: "bg-exact-blue",
    // fillColor: "fill-exact-blue",
    // darkColor: "dark:exact-blue",
    // shadowColor: "shadow-exact-blue",
    exactColor: "exact-blue",
  },
  {
    svgIcon: (
      <g transform="translate(0.000000,32.000000) scale(0.050000,-0.050000)">
    ...
    desc: "We also help you market your products through an online marketplace",
    // bgColor: "bg-exact-orange",
    // fillColor: "fill-exact-orange",
    // darkColor: "dark:exact-orange",
    // shadowColor: "shadow-exact-orange",
    exactColor: "exact-orange",
  },
];
